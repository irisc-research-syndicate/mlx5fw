...
impl ItocEntryType {
    pub fn is_code(&self) -> bool {
        matches!(*self, ItocEntryType::PciCode | ItocEntryType::MainCode | ItocEntryType::PcieLinkCode | ItocEntryType::IronPrepCode | ItocEntryType::PostIronBootCode | ItocEntryType::UpgradeCode)
    }
}
